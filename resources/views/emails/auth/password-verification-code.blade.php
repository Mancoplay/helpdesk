    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;">
        <tr>
            <td style="background:#ffffff;border-radius:14px;padding:28px;border:1px solid #e5e7eb;">
                <h1 style="margin:0 0 10px 0;font-size:22px;color:#0f172a;">Recuperación de contraseña</h1>
                <p style="margin:0 0 18px 0;font-size:15px;line-height:1.55;color:#334155;">
                    Recibimos una solicitud para cambiar tu contraseña. Usa este código de verificación:
                </p>
